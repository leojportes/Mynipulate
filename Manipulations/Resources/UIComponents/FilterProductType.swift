...
//import UIKit
//
//struct FilterProductItem {
//    let productName: String
//}
//
//
//final class FilterProductType: UIView, ViewCodeContract {
//
//    private var didSelectIndexClosure: (FilterProductItem) -> Void?
//    private var didSelectDateClosure: (String) -> Void?
//    
//    var segmentedControlButtons: [UIButton] = []
//    
//    let all = SegmentedControlButton(item: FilterProductItem)
...
//        handleSegmentedControlButtons()
//        custom.backgroundColor = .neutral
//    }
//
//    @objc
...
////                self.didSelectIndexClosure(.init(productName: <#T##String#>))
//            } else {
...
//}
//
//class FilterProductTypeButton: UIButton {
//
//    // MARK: - Init
...
//    
//    // MARK: - Init
//    init(item: FilterProductItem) {
//        super.init(frame: .zero)
//        self.translatesAutoresizingMaskIntoConstraints = false
//        self.setTitle(item.productName, for: .normal)
